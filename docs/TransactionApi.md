...
//import com.squareup.connect.api.TransactionApi;
...
try {
    ...
    System.err.println("Exception when calling TransactionApi#captureTransaction");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling TransactionApi#charge");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling TransactionApi#retrieveTransaction");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling TransactionApi#voidTransaction");
    e.printStackTrace();
}
```
