...
**order** | [**Squareupconnectv2ordersserviceCreateOrderRequestOrder**](Squareupconnectv2ordersserviceCreateOrderRequestOrder.md) | The order including line items to be checked out. | 
