...
public enum V1CashDrawerEventEventType {
  ...
  V1CashDrawerEventEventType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static V1CashDrawerEventEventType fromValue(String text) {
    for (V1CashDrawerEventEventType b : V1CashDrawerEventEventType.values()) {
