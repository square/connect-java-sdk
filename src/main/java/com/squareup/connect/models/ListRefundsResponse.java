 ...
 */
@ApiModel(description = "Defines the fields that are included in the response body of a request to the ListRefunds endpoint.  One of `errors` or `refunds` is present in a given response (never both).")
