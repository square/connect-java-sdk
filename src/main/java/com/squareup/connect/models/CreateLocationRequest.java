...
public class CreateLocationRequest {
   ...
   * @return location
  **/
  @ApiModelProperty(value = "The initial values of the location being created. The `name` field is required. All other fields are optional. Unspecified fields will be set to default values using existing location data.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.location, createLocationRequest.location);
  }
