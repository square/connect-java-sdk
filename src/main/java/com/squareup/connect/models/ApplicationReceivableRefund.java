 ...
 */
@ApiModel(description = "A refund of an [ApplicationReceivable](#type-applicationreceivable). This includes the ID of the application receivable associated to this object, as well as a reference to the [Refund](#type-refund) that created this receivable refund.")

public class ApplicationReceivableRefund {
  @JsonProperty("id")
  ...
  public ApplicationReceivableRefund id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public ApplicationReceivableRefund receivableId(String receivableId) {
  ...
  **/
  ...
  public ApplicationReceivableRefund refundId(String refundId) {
  ...
  **/
  ...
  public ApplicationReceivableRefund transactionLocationId(String transactionLocationId) {
  ...
  **/
  ...
  public ApplicationReceivableRefund amountMoney(Money amountMoney) {
  ...
  **/
  ...
  public ApplicationReceivableRefund createdAt(String createdAt) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ApplicationReceivableRefund applicationReceivableRefund = (ApplicationReceivableRefund) o;
    return Objects.equals(this.id, applicationReceivableRefund.id) &&
        Objects.equals(this.receivableId, applicationReceivableRefund.receivableId) &&
        Objects.equals(this.refundId, applicationReceivableRefund.refundId) &&
        Objects.equals(this.transactionLocationId, applicationReceivableRefund.transactionLocationId) &&
        Objects.equals(this.amountMoney, applicationReceivableRefund.amountMoney) &&
        Objects.equals(this.createdAt, applicationReceivableRefund.createdAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApplicationReceivableRefund {\n");
